...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-1.5 rounded-[10px]",
        "border border-transparent bg-secondary",
        "py-1.5 pr-2 pl-3 text-[13.5px] tracking-[-0.005em] whitespace-nowrap",
        "transition-[box-shadow,background-color] duration-150 [transition-timing-function:var(--ease-ios)]",
        ...
        "data-[size=default]:h-9 data-[size=sm]:h-7 data-[size=sm]:text-[12.5px]",
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={
          <ChevronDownIcon className="pointer-events-none size-3.5 text-muted-foreground/80" />
        }
      />
    </SelectPrimitive.Trigger>
  )
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "rounded-[8px] py-1.5 pr-8 pl-2 text-[13.5px] tracking-[-0.005em]",
    ...
    >
      ...
      >
        <CheckIcon className="pointer-events-none text-primary" strokeWidth={2.4} />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  )
}
