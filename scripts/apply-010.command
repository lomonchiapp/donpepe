...
echo ""
echo "=========================================="
echo " Don Pepe — aplicando migración 010"
echo " (spot metales + gastos + oro disponible)"
echo "=========================================="
echo ""

node scripts/apply-010.mjs

status=$?
echo ""
if [ $status -eq 0 ]; then
  echo "✅ TERMINÓ BIEN. Puedes cerrar esta ventana."
  echo "⚠️  Borra este archivo (apply-010.command) — tiene el password."
else
