#!/bin/bash
# Aplica migraciones 004+005+006+007 al Supabase del proyecto.
...
echo ""
echo "=========================================="
echo " Don Pepe — aplicando migraciones 004→007"
echo "=========================================="
echo ""
...
if [ $status -eq 0 ]; then
  ...
  echo "⚠️  Borra este archivo (apply-migrations.command) — tiene el password."
else
