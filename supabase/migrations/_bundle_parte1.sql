-- ============================================================
-- PARTE 1/2 — Bundle: 004 + 005 + 006 + (007 sección 1: nuevos valores de enum)
-- Correr ESTA PRIMERO, hacer Run. Después correr PARTE 2/2.
-- Separado porque Postgres no permite usar un valor de enum recién
-- agregado en la misma transacción que lo agregó.
-- ============================================================
